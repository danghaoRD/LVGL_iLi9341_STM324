...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_Screen1, lv_color_hex(0x57D9E8), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Screen1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_TextArea1 = lv_textarea_create(ui_Screen1);
    lv_obj_set_width(ui_TextArea1, 66);
    ...
    lv_obj_set_width(ui_Slider1, 237);
    lv_obj_set_height(ui_Slider1, 10);
    lv_obj_set_x(ui_Slider1, -2);
    lv_obj_set_y(ui_Slider1, -11);
    lv_obj_set_align(ui_Slider1, LV_ALIGN_CENTER);

    lv_obj_set_style_bg_color(ui_Slider1, lv_color_hex(0xE01E11), LV_PART_KNOB | LV_STATE_DEFAULT);
